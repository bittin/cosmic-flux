...
use cosmic::iced::{window::Id, Alignment, Length, Limits, Subscription, alignment};
...
impl cosmic::Application for AppModel {
    ...
    fn view_window(&self, _id: Id) -> Element<'_, Message> {
        ...
        if self.daemon_playing {
            // Three equal-width, center-aligned columns (CPU | RAM | FPS)
            // separated by short vertical rules.
            ...
            // Cap each divider to a fixed height so it reads as a clean tick
            // between the columns rather than a full-height line.
